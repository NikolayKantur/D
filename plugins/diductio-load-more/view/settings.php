<div class="wrap">
    <h1><?php _e('Ajax More Load - Users', 'ajax-load-more-users') ?></h1>

    <p><?php _e('Use shortcode <code>[ajax_load_more_users]</code> to display activate infinite scroll.', 'ajax-load-more-users') ?></p>

    <h2><?php _e('Shortcode Parameters', 'ajax-load-more-users') ?></h2>
