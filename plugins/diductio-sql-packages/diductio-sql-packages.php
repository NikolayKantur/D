<?php
/*
Plugin Name: Diductio SQL Packages
Description: Позволяет накатывать большие обновления базы данных
Text Domain: diductio-sql-packages
Author: Danil T.
Version: 1.0.0
License: GPL 3.0
*/

namespace DiductioSqlPackages;
